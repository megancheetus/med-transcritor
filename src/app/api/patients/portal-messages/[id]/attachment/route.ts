...
import { getPatientPortalMessageForProfessional } from '@/lib/patientPortalMessageManager';
...
export async function GET(request: NextRequest, { params }: RouteParams) {
  try {
    ...
    const message = await getPatientPortalMessageForProfessional(user.username, idValidation.data.id);
    ...
    console.error('[patients/portal-messages/:id/attachment] GET error:', error);
